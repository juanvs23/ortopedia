...
if ( ! function_exists( 'emallshop_import_presets' ) ){
	function emallshop_import_presets(){
		return array(
				'default' => array(
					'alt'     => 'Default', 'img'=> EMALLSHOP_ADMIN_IMAGES . '/presets/default.jpg'
				),
				'general' => array(
					'alt'     => 'General', 'img'=> EMALLSHOP_ADMIN_IMAGES . '/presets/general.jpg'
				),
				'electronic' => array(
					'alt'     => 'Electronic', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/electronic.jpg'
				),
				'beauty' => array(
					'alt'     => 'Beauty', 'img'=> EMALLSHOP_ADMIN_IMAGES . '/presets/beauty.jpg'
				),
				'bodybuilder' => array(
					'alt'     => 'Bodybuilder', 'img'=> EMALLSHOP_ADMIN_IMAGES . '/presets/bodybuilder.jpg'
				),
				'jewellery' => array(
					'alt'     => 'Jewellery', 'img'=> EMALLSHOP_ADMIN_IMAGES . '/presets/jewellery.jpg'
				),
				'furniture' => array(
					'alt'     => 'Furniture', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/furniture.jpg'
				),
				'kids' => array(
					'alt'     => 'Kids', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/kids.jpg'
				),
				'mobile' => array(
					'alt'     => 'Mobile', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/mobile.jpg'
				),
				'sport' => array(
					'alt'     => 'Sport', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/sport.jpg'
				),
				'medical' => array(
					'alt'     => 'Medical', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/medical.jpg'
				),
				'organic' => array(
					'alt'     => 'Organic', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/organic.jpg'
				),
				'vegetable' => array(
					'alt'     => 'Vegetable', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/vegetable.jpg'
				),
				'wine' => array(
					'alt'     => 'Wine', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/wine.jpg'
				),
				'underwear' => array(
					'alt'     => 'Underwear', 'img' => EMALLSHOP_ADMIN_IMAGES . '/presets/underwear.jpg'
				),
			);
	}
}