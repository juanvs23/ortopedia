...
if (!class_exists('EMALLSHOP_SIDEBAR')) {
	...
	class EMALLSHOP_SIDEBAR{
		...
		public function enqueue_assets() {
			...
			wp_enqueue_script('custom_sidebar_js' , EMALLSHOP_ADMIN_URI . '//assets/js/custom_sidebar.js');
			wp_enqueue_style( 'custom_sidebar_css' , EMALLSHOP_ADMIN_URI . '/assets/css/custom_sidebar.css');
		}
