...
if ( ! function_exists( 'theme_css' ) ) {
	function theme_css() {
		...
		wp_enqueue_style( 'woocommerce', EMALLSHOP_CSS . '/woocommerce.css', array(), '' );
		wp_enqueue_style( 'woocommerce-layout', EMALLSHOP_CSS . '/woocommerce-layout.css', array(), '' );
		wp_enqueue_style( 'owl-carousel', EMALLSHOP_CSS . '/owl.carousel.min.css', array(), '' );
		wp_enqueue_style( 'owl-theme-default-min', EMALLSHOP_CSS . '/owl.theme.default.min.css', array(), '' );
		wp_enqueue_style( 'slick-slider', EMALLSHOP_CSS . '/slick.css', array(), '' );
		wp_enqueue_style( 'magnific-popup', EMALLSHOP_CSS . '/magnific-popup.css', array(), '' );
		wp_enqueue_style( 'animate-css', EMALLSHOP_CSS . '/animate.css', array(), '' );	
...
add_action( 'wp_enqueue_scripts', 'theme_css', 10000 );	
...
if ( ! function_exists( 'theme_js' ) ) {
	function theme_js() {
		...
		wp_enqueue_script( 'jquery-countdown', EMALLSHOP_JS . '/jquery.countdown.plugin.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'countdown.min', EMALLSHOP_JS . '/jquery.countdown.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'jquery-magnific-popup', EMALLSHOP_JS . '/jquery.magnific-popup.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'jquery-lazyloadxt', EMALLSHOP_JS . '/jquery.lazyloadxt.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'jquery-hideMaxListItem', EMALLSHOP_JS . '/hideMaxListItem-min.js', array( 'jquery' ), '', true );
		...
		wp_enqueue_script( 'cookie.min', EMALLSHOP_JS . '/jquery.cookie.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'cookiealert', EMALLSHOP_JS . '/cookiealert.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'owl.carousel.min', EMALLSHOP_JS . '/owl.carousel.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'jquery-slick', EMALLSHOP_JS . '/slick.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'modernizr.custom', EMALLSHOP_JS . '/modernizr.custom.js', array( 'jquery' ), '', true );
			...
			<?php if($header_style=="header-5" || $header_style=="header-10"){?>			
				<div class="heading-cart cart-style-1">
					<a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>">
						...
						<span class="mini-cart-count"><?php echo sprintf(_n('%d item', '%d item(s)', $woocommerce->cart->cart_contents_count, 'emallshop'), $woocommerce->cart->cart_contents_count);?> - <?php echo emallshop_output( $woocommerce->cart->get_cart_total() ); ?></span>
					</a>
				</div>				
		...
		if ( has_nav_menu( 'vertical_menu' ) ) { ?>
			<div class="category-menu open">
				<div class="category-menu-title">
					<h4><?php echo ( emallshop_output($title) !=null) ? esc_attr($title) : emallshop_get_option('shopping-categories-text', esc_html__('Shopping Categories','emallshop'));?></h4>
...
if(!function_exists('emallshop_google_analytics')) {
	...
	function emallshop_print_google_code() {
		...
		if(!empty($googleCode)) {
			echo emallshop_output( $googleCode );
		}
	}
}
		...
		<div class="social-share <?php echo emallshop_get_option('social-sharing-style', 'style-1'); ?>">	
			...
			<ul class="social-link">	
				<?php if( emallshop_get_option( 'social-share-fb', 1 ) ): ?>
					<li class="icon-facebook"><a title="<?php echo esc_html__( 'Share on Facebook', 'emallshop' ); ?>" href="//www.facebook.com/sharer.php?u=<?php echo emallshop_output( $post_link ); ?>" onclick="window.open(this.href,this.title,'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=500,height=500,top=300px,left=300px');  return false;">
						<i class="fa fa-facebook"></i>
					</a></li>
				<?php endif; ?>	
				<?php if( emallshop_get_option( 'social-share-tw', 1 ) ): ?>
					<li class="icon-twitter"><a title="<?php echo esc_html__( 'Share on Twitter', 'emallshop' ); ?>" href="//twitter.com/share?url=<?php echo emallshop_output( $post_link ); ?>" onclick="window.open(this.href,this.title,'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=500,height=500,top=300px,left=300px');  return false;">
						<i class="fa fa-twitter"></i>
					</a></li>
				<?php endif; ?>
				<?php if( emallshop_get_option( 'social-share-in', 1 ) ): ?>
					<li  class="icon-linkedin"><a title="<?php echo esc_html__( 'Share on LinkedIn', 'emallshop' ); ?>" href="//www.linkedin.com/shareArticle?mini=true&url=<?php echo emallshop_output( $post_link ); ?>&title=<?php echo emallshop_output( $post_title ); ?>" onclick="window.open(this.href,this.title,'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=500,height=500,top=300px,left=300px');  return false;">
						<i class="fa fa-linkedin"></i>
					</a></li>
				<?php endif; ?>
				<?php if( emallshop_get_option( 'social-share-gp', 1 ) ): ?>
					<li  class="icon-google-plus"><a title="<?php echo esc_html__( 'Share on Google Plus', 'emallshop' ); ?>" href="//plus.google.com/share?url=<?php echo emallshop_output( $post_link ); ?>" onclick="window.open(this.href,this.title,'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=500,height=500,top=300px,left=300px');  return false;">
						<i class="fa fa-google-plus"></i>
					</a></li>
				<?php endif; ?>			
				<?php if( emallshop_get_option( 'social-share-sl', 1 ) ): ?>
					<li  class="icon-submit"><a title="<?php echo esc_html__( 'Share on Stumbleupon', 'emallshop' ); ?>" href="//www.stumbleupon.com/submit?url=<?php echo emallshop_output( $post_link ); ?>&title=<?php echo emallshop_output( $post_title ); ?>" onclick="window.open(this.href,this.title,'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=500,height=500,top=300px,left=300px');  return false;">
						<i class="fa fa-stumbleupon"></i>
					</a></li>
				<?php endif; ?>
				<?php if( emallshop_get_option( 'social-share-pr', 1 ) ): ?>
					<li  class="icon-pinterest"><a title="<?php echo esc_html__( 'Share on Pinterest', 'emallshop' ); ?>" href="//pinterest.com/pin/create/button/?url=<?php echo emallshop_output( $post_link ); ?>&media=<?php echo esc_url( $src[0] ); ?>&description=<?php echo emallshop_output( $post_title ); ?>" onclick="window.open(this.href,this.title,'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=500,height=500,top=300px,left=300px');  return false;">
						<i class="fa fa-pinterest"></i>
					</a></li>
				<?php endif; ?>
				<?php if( emallshop_get_option( 'social-share-tl', 1 ) ): ?>
					<li  class="icon-tumblr"><a title="<?php echo esc_html__( 'Share on Tumblr', 'emallshop' ); ?>" href="//tumblr.com/widgets/share/tool?canonicalUrl=<?php echo emallshop_output( $post_link ); ?>" onclick="window.open(this.href,this.title,'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=500,height=500,top=300px,left=300px');  return false;">
