...
if( ! function_exists( 'emallshop_template_loop_product_thumbnail' ) ) {
	function emallshop_template_loop_product_thumbnail(){
		...
		echo emallshop_output( $thumb_image );
		echo emallshop_output( $attachment_image );
	}
}
...
function emallshop_product_rating_html( $rating = null ) {
    ...
    echo emallshop_output( $rating_html );
			...
			<?php if ( ! empty( $prev ) ): ?>
				<div class="product-prev">
					...
					<div class="product-prev-popup">
						...
						<?php echo emallshop_output( $prev->get_price_html() ); ?>
						</div>
					</div>
					</a>
				</div>
			...
			<div class="product-next">				
				...
				<div class="product-next-popup">
					...
					<div class="product-title-price">
						...
						<?php echo emallshop_output( $next->get_price_html() ); ?>
					</div>
				</div>
				</a>
			</div>
...
if( ! function_exists( 'emallshop_template_single_availability' ) ) {
	function emallshop_template_single_availability() {
		...
		<span class="availability <?php echo emallshop_output( $product->is_in_stock() ) ? 'instock' : ''; ?>"><?php echo emallshop_output( $product->is_in_stock() ) ? esc_html__('In  Stock','emallshop') : ''; ?></span>
